...
const MenuContent = () => {
  ...
  return (
    <>
      <div onClick={handleCatalog} className="flex flex-col hover:bg-gray-100 cursor-pointer transition-all duration-300 rounded-lg gap-2 items-center justify-center p-3 shadow-md">
        <img className="w-20 h-20 " src={Bouquet} alt="flower" />
      ...
      <div onClick={handleFormulir} className="flex flex-col hover:bg-gray-100 cursor-pointer transition-all duration-300 rounded-lg gap-2 items-center justify-center p-3 shadow-md">
        <img className="w-20 h-20 " src={FormulirImg} alt="formulir" />
      ...
      <div className="flex flex-col hover:bg-gray-100 cursor-pointer transition-all duration-300 rounded-lg gap-2 items-center justify-center p-3 shadow-md">
        <img className="w-20 h-20 " src={CashImg} alt="Cash" />
      ...
      <div onClick={handleLacak} className="flex flex-col hover:bg-gray-100 cursor-pointer transition-all duration-300 rounded-lg gap-2 items-center justify-center p-3 shadow-md">
        <img className="w-20 h-20 " src={TruckImg} alt="Delivery" />
