  ...
  return (
    <nav className="bg-white  border-gray-200 shadow-md">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <button onClick={() => setIsOpen(!isOpen)} data-collapse-toggle="navbar-default" type="button" className="inline-flex items-center p-2 w-10 h-10 justify-center text-sm  rounded-lg md:hidden hover:bg-[#C7A700] focus:outline-none focus:ring-2  hover:text-white  " aria-controls="navbar-default" aria-expanded="false">
        ...
        <div className={`${isOpen ? "max-h-96 opacity-100" : "max-h-0 opacity-0"} md:opacity-100 md:max-h-screen overflow-hidden transition-all duration-700 ease-in-out w-full md:block md:w-auto`}>
          <ul className="font-medium flex flex-col items-center p-4 md:p-0 mt-4 border border-gray-100 rounded-lg md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white bg-[#C7A700]">
            ...
            <li>
              <a href="/about" className="block py-2 px-3  hover:text-white font-semibold text-lg md:hover:text-[#C7A700]">
                Tentang
              </a>
            </li>
            <li>
            ...
            <li>
              <a href="/kontak" className="block py-2 px-3  hover:text-white font-semibold text-lg md:hover:text-[#C7A700]">
                Kontak
              </a>
            </li>
          </ul>
